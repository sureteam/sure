...
$qdelete="DELETE FROM tbl_agency where  id='$value'";
...
echo "<div class=removed>Code ( ".$value ." ), "." Agency Name ( ". $gname ." ) Deleted</div><BR> ";
...
?>
<br />
<input type=button value="Refresh" onClick="self.location='admin.php?action=page&icon=agencyview&t=viewAgency'" class="buttonclass">
<?php
}
?>