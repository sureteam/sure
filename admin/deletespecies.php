...
$qdelete="DELETE FROM tbl_species where  id='$value'";
...
echo "<div class=removed>Code ( ".$value ." ), "." Specie Name ( ". $gname ." ) Deleted</div><BR> ";
...
?>
<br />
<input type=button value="Refresh" onClick="self.location='admin.php?action=page&icon=speciesview&t=Species'" class="buttonclass">
<?php
}
?>