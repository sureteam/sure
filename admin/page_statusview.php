...
<div class="head"> Status View / Edit</div>
...
<input type="submit" value="Refresh"  onclick="window.location='admin.php?action=page&icon=statusview&t=viewStatus';" class="refreshbutton"/>  
...
echo "<div class=warning>  Check atleast a status you want to change. </div>";
...
<input name="cancel" type="submit" value="Cancel" onclick="window.location='admin.php?action=page&icon=statusview&t=Statusviews';" class="clearbutton" /> 
</div>
  <?php
}// else
...
$query = "update tbl_status set  name= '$sname' where id='$id'";
$result=mysqli_query($mysqli, $query) or die(mysqli_error());
echo $item="<div class=success> Status Succussfullly Done <font color=red>".strtoupper($catname[$name])."</font></div>";
}
...
<?php
echo "Are  you Sure you want to Delete id ( ".$value ." ), "." Status Name ( ". $gname ." )<br>";
echo "</div>";
...
<h4 class="sets"> 
     ...
     &nbsp;|| &nbsp;
      <a href="admin.php?action=page&icon=statusview&t=viewStatus" class="currentx">
      NO </a>
