...
$qdelete="DELETE FROM tbl_offence where  id='$value'";
...
echo "<div class=removed>Code ( ".$value ." ), "." Offence Name ( ". $gname ." ) Deleted</div><BR> ";
...
?>
<br />
<input type=button value="Refresh" onClick="self.location='admin.php?action=page&icon=offenceview&t=Offence'" class="buttonclass">
<?php
}
?>