...
<div class="head"> Offence View / Edit</div>
...
$item='Offence';
$limit=20;
$query="select * from tbl_offence order by  id asc";
...
<input type="submit" value="Refresh"  onclick="window.location='admin.php?action=page&icon=stationview&t=viewstations';" class="refreshbutton"/>  
...
echo "<div class=warning>  Check atleast a offence you want to change. </div>";
...
<input name="cancel" type="submit" value="Cancel" onclick="window.location='admin.php?action=page&icon=offenceview&t=Offenceviews';" class="clearbutton" /> 
</div>
  <?php
}// else
...
$query = "update tbl_offence set  name= '$ofname' where id='$id'";
$result=mysqli_query($mysqli, $query) or die(mysqli_error());
echo $item="<div class=success> Offence Succussfullly Done <font color=red>".strtoupper($catname[$name])."</font></div>";
}
...
<?php
echo "Are  you Sure you want to Delete id ( ".$value ." ), "." Offence Name ( ". $gname ." )<br>";
echo "</div>";
...
<h4 class="sets"> 
     ...
     &nbsp;|| &nbsp;
      <a href="admin.php?action=page&icon=offenceview&t=viewOffences" class="currentx">
      NO </a>
