...
if(!$customertype){
echo " <div class=warning>StatusName value must be entered!</div>";
}else{
$obj->addstatus($customertype, $mysqli);
...
<table width="100%" border="0">
  <tr>
    <td colspan="2"><div class="head">Add New Status</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input name="Send" type="submit" id="Send" value="Add Status" class="buttonclass"  />
      <span class="buttons">
